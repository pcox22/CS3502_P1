...
namespace OS_SubwaySystem {
	class Driver
	{
		...
		static void Main(string[] args)
		{
			...
			List<CTrain> Subway = new List<CTrain>();
			...
			for (int i = 0; i < 10; i++)
			{
				...
				CTrain cTrain = new CTrain(random.Next(4));
				Subway.Add(cTrain);
			...
			if (!deadlocked)
			{
				Console.WriteLine("All operations completed - Total Successful: " + CTrain.getTotalOperations());
			}
			else
			{
